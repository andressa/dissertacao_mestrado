...
As seções~\ref{dataset} e~\ref{selection} descrevem, respectivamente, o conjunto de dados adquiridos e os atributos que foram previamente selecionados; A seção~\ref{ensemble} descreve os algorítimos de máquina de aprendizado utilizados;
